...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \n#line 3 \"library/cpp/array/segtree/initialization/segment_tree_lazy.rsq_ruq.hpp\"\
    ...
    \        if (m2 == em) return m1;\n        return m2;\n    };\n    auto apply\
    \ = [em](X x, M m){return (m==em ? x : X(m * x.len, x.len));};\n    return segment_tree_lazy<X,\
    \ M>(merge, apply, composition, ex, em);\n}\n// auto lseg = make_lseg_rsq_ruq();\n\
    // lseg.build(vector<X>(sz, X(<\u521D\u671F\u5024>, 1))); // X(*, 1)\u3092\u5165\
    \u308C\u306A\u3044\u3068\u3044\u3051\u306A\u3044\u3053\u3068\u306B\u6CE8\u610F\
    \u3059\u308B\u3002\n\n//%snippet.end()%\n#line 2 \"library/cpp/include/segment_tree_lazy.rsq_ruq.hpp\"\
    \n"
  code: '#include "../array/segtree/initialization/segment_tree_lazy.rsq_ruq.hpp"'
  dependsOn:
  ...
  verifiedWith: []
documentation_of: library/cpp/include/segment_tree_lazy.rsq_ruq.hpp
layout: document
redirect_from:
- /library/library/cpp/include/segment_tree_lazy.rsq_ruq.hpp
- /library/library/cpp/include/segment_tree_lazy.rsq_ruq.hpp.html
