...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    // z(x[i]); -> zipped x[i]\n// z.unzip(z(x[i])) -> x[i];\n// z.zip(ll x) -> zipped\
    \ x\n// z.zip(vl v) -> zipped v\n// }}}\n\n//%snippet.end()%\n#line 2 \"library/cpp/include/zipper.hpp\"\
    \n"
  code: '#include "../misc/zipper.lib/zipper.hpp"'
  dependsOn:
  ...
  verifiedWith: []
documentation_of: library/cpp/include/zipper.hpp
layout: document
redirect_from:
- /library/library/cpp/include/zipper.hpp
- /library/library/cpp/include/zipper.hpp.html
