...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \ e.from << \",\" << e.to << \")\";\n        return os;\n    }\n};\n//%snippet.end()%\n\
    #line 2 \"library/cpp/include/edge.hpp\"\n"
  code: '#include "../graph/edge.hpp"'
  dependsOn:
  ...
  verifiedWith: []
documentation_of: library/cpp/include/edge.hpp
layout: document
redirect_from:
- /library/library/cpp/include/edge.hpp
- /library/library/cpp/include/edge.hpp.html
