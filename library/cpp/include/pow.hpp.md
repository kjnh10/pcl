...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \ return x^n\n    T res(e);\n    while (n > 0) {\n        if (n & 1) res *= x;\n\
    \        x *= x;\n        n >>= 1;\n    }\n    return res;\n}\n\n//%snippet.end()%\n\
    #line 2 \"library/cpp/include/pow.hpp\"\n"
  ...
  verifiedWith: []
documentation_of: library/cpp/include/pow.hpp
layout: document
redirect_from:
- /library/library/cpp/include/pow.hpp
- /library/library/cpp/include/pow.hpp.html
