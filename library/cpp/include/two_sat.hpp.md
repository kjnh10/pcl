...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \n//%snippet.end()%\n#line 2 \"library/cpp/include/two_sat.hpp\"\n"
  code: '#include "../graph/two_sat.hpp"'
  dependsOn:
...
layout: document
redirect_from:
- /library/library/cpp/include/two_sat.hpp
- /library/library/cpp/include/two_sat.hpp.html
