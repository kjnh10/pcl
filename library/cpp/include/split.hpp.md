...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \ += s[i]; }\n    }\n    return res;\n}\n\n//%snippet.end()%\n#line 2 \"library/cpp/include/split.hpp\"\
    \n"
  code: '#include "../string/split.hpp"'
  dependsOn:
  ...
  verifiedWith: []
documentation_of: library/cpp/include/split.hpp
layout: document
redirect_from:
- /library/library/cpp/include/split.hpp
- /library/library/cpp/include/split.hpp.html
