...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \ m) = m && apply(x, em) = x\n\n//%snippet.end()%\n\n#line 2 \"library/cpp/include/segment_tree_lazy.hpp\"\
    \n"
  code: '#include "../array/segtree/segment_tree_lazy.hpp"'
  dependsOn:
  ...
  verifiedWith: []
documentation_of: library/cpp/include/segment_tree_lazy.hpp
layout: document
redirect_from:
- /library/library/cpp/include/segment_tree_lazy.hpp
- /library/library/cpp/include/segment_tree_lazy.hpp.html
