...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \                pos.erase(loop[i]);\n                }\n            }\n     \
    \       return ans;\n        }\n    }\n    return {};\n}\n\n//%snippet.end()%\n\
    #line 2 \"library/cpp/include/local_min_cycle.hpp\"\n"
  code: '#include "../graph/local_min_cycle.hpp"'
  dependsOn:
  ...
  verifiedWith: []
documentation_of: library/cpp/include/local_min_cycle.hpp
layout: document
redirect_from:
- /library/library/cpp/include/local_min_cycle.hpp
- /library/library/cpp/include/local_min_cycle.hpp.html
