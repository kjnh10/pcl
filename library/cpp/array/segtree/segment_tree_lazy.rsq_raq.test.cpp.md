...
data:
  ...
  bundledCode: "#line 1 \"library/cpp/array/segtree/segment_tree_lazy.rsq_raq.test.cpp\"\
    ...
    */\n\n//%snippet.end()%\n\n#line 3 \"library/cpp/array/segtree/segment_tree_lazy.rsq_raq.test.cpp\"\
    ...
    \  // s.t composition(m, em) = m && s.t composition(em, m) = m && apply(x, em)\
    \ = x\n    auto composition = [&](M m1, M m2){ return m1 + m2; };\n    auto apply\
    \ = [&](X x, M m){return X(x.x + m*x.len, x.len);};\n    return segment_tree_lazy<X,\
...
layout: document
redirect_from:
- /verify/library/cpp/array/segtree/segment_tree_lazy.rsq_raq.test.cpp
- /verify/library/cpp/array/segtree/segment_tree_lazy.rsq_raq.test.cpp.html
