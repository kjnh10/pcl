...
data:
  ...
  bundledCode: "#line 1 \"library/cpp/graph/tree.lib/kth_root.test.cpp\"\n#define\
    ...
    \ d = N-1; d >= 0; d--) {\n            if (db[d][u] != db[d][v]) {\n         \
    \       u = db[d][u];\n                v = db[d][v];\n            }\n        }\n\
    \        return tr.par[u];\n    }\n};\n#line 3 \"library/cpp/graph/tree.lib/kth_root.test.cpp\"\
    \n\nint main() {\n    int n, q;\n    cin >> n >> q;\n    tree tr(n);\n    rep(u,\
    \ 1, n) {\n        int p;\n        cin >> p;\n        tr.add_edge(p, u);\n   \
    \ }\n    tr.build(0);\n\n    auto ta = kth_root(tr);\n\n    rep(_, q) {\n    \
  ...
  verifiedWith: []
documentation_of: library/cpp/graph/tree.lib/kth_root.test.cpp
layout: document
redirect_from:
- /verify/library/cpp/graph/tree.lib/kth_root.test.cpp
- /verify/library/cpp/graph/tree.lib/kth_root.test.cpp.html
