...
data:
  ...
  bundledCode: "#line 2 \"library/cpp/header.hpp\"\n\n//%snippet.set('header')%\n\
    ...
    \u5909\u66F4\u3059\u308B\u306E\u3082\u5FD8\u308C\u306A\u3044\u3002\n    // int\
    \ dx[] = {1, 0};\n    // int dy[] = {0, 1};\n    rep(i, h) rep(j, w) {\n     \
    \   if (grid[i][j]=='#') continue;  // block\u304B\u3089\u51FA\u308B\u8FBA\u306F\
    \u306A\u3044\n        rep(dir, 4) {\n            int ni = i + dx[dir];\n     \
    \       int nj = j + dy[dir];\n            if (is_in(ni, 0, h) && is_in(nj, 0,\
    \ w)) {\n                if (grid[ni][nj]=='#') continue;  // block\u306B\u5165\
  ...
  code: "#include \"../header.hpp\"\n#include \"graph.hpp\"\n\nint main() {\n    //%snippet.set('gridgraph')%\n\
    ...
    \ >> grid[i];\n    }\n\n    Graph g(n);\n\n    auto nid = [&](int i, int j){return\
    \ (i*w + j);};\n    // int u = nid(i, j);\n    auto pos = [&](int u) -> pair<int,\
    \ int> { return {u/w, u%w}; };\n    // auto [i,j] = pos(u);\n\n    int dx[] =\
    \ {1, -1, 0, 0};\n    int dy[] = {0, 0, 1, -1};\n\n    // \u4E0B\u3068\u53F3\u306E\
    \u307F. rep(k, 4)\u3092rep(k, 2)\u306B\u5909\u66F4\u3059\u308B\u306E\u3082\u5FD8\
    \u308C\u306A\u3044\u3002\n    // int dx[] = {1, 0};\n    // int dy[] = {0, 1};\n\
    \    rep(i, h) rep(j, w) {\n        if (grid[i][j]=='#') continue;  // block\u304B\
    \u3089\u51FA\u308B\u8FBA\u306F\u306A\u3044\n        rep(dir, 4) {\n          \
    \  int ni = i + dx[dir];\n            int nj = j + dy[dir];\n            if (is_in(ni,\
  ...
  requiredBy: []
  timestamp: '2020-11-30 22:24:37+09:00'
