...
data:
  ...
  bundledCode: "#line 1 \"library/cpp/graph/tests/graph.bipartie.test.cpp\"\n// @ignore\n\
    ...
    \ };/*}}}*/\n};\n\n//%snippet.end()%\n#line 5 \"library/cpp/graph/tests/graph.bipartie.test.cpp\"\
    \n\nsigned main() {\n    int n, m;\n    cin >> n >> m;\n    Graph<ll> g(n);\n\
    \    rep(i, m) {\n        int a, b;\n        cin >> a >> b;\n        a--;\n  \
  ...
  verifiedWith: []
documentation_of: library/cpp/graph/tests/graph.bipartie.test.cpp
layout: document
redirect_from:
- /verify/library/cpp/graph/tests/graph.bipartie.test.cpp
- /verify/library/cpp/graph/tests/graph.bipartie.test.cpp.html
